        ...
        if (isPlayerProp && stats) {
            ...
            try {
                ...
                if (sport === 'nba' && bdlPlayerId) {
                    ...
                    console.log(`[V7.0] ✅ Full enrichment complete: Matrix=${!!v7Matrix}, Advanced=${!!v7Advanced}, Shooting=${!!v7Shooting}, Clutch=${!!v7Clutch}, OppProfile=${!!v7OppProfile}, Sharp=${!!v7SharpMoney}, GameScript=${!!v7GameScript}, Spots=${v7Spots.length}`);
                }
